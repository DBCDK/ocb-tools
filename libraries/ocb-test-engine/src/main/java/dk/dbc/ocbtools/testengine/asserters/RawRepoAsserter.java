...
public class RawRepoAsserter {
    public static void assertRecordListEquals( List<TestcaseRecord> expected, List<Record> actual ) {
        ...
        try {
            ...
            if( expected.size() != actual.size() ) {
                ...
                message += "Expected: [";
                for( TestcaseRecord expectedRecord : expected ) {
                    message += "\n";
            ...
            for( TestcaseRecord testRecord : expected ) {
    ...
    private static void assertRecordEqual( TestcaseRecord expected, Record actual ) throws IOException {
        logger.entry( expected, actual );
    ...
    public static void assertQueueRecords( List<TestcaseRecord> expected, List<RecordId> queuedRecords ) throws IOException {
    ...
    public static void assertRecordRelations( TestcaseRecord expected, RawRepoRelationType relationType, Set<RecordId> relations ) throws IOException {
